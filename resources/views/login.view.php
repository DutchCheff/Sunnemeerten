...
<div class="bg-inherit">
    ...
    <div class="bg-card shadow-md mx-7 mb-4 rounded-2xl text-text px-6 py-4">
        ...
        <form action="sign-in">
            ...
            <div>
                <button class="bg-accent1 text-text px-4 py-1 rounded-lg w-full mb-2 mt-2 text-base">
                    Inloggen
                </button>
            </div>
            <div class="flex gap-2 w-full">
                <div class="w-1/2">
                    <button class="bg-accent2 text-text px-4 py-1 rounded-lg w-full mb-4 mt-2 text-base">
                        Gast
                    </button>
                </div>
                <div class="w-1/2">
                    <button class="bg-background text-text px-4 py-1 rounded-lg w-full mb-4 mt-2 text-base">
                        Registreren
                    </button>
                </div>
            </div>
